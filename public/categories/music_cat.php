...
<?php
	...
	include("..\..\includes\layouts\header_cat.php");
	$query = "SELECT * FROM createevent WHERE eventtype = 'Music Festivals'";
...
?>
		...
		<h1>MUSIC &nbsp;&nbsp;EVENTS</h1>
			<table class="table_events">
				...
				<tr>
					<th><button><a href="registration.php">JOIN EVENT</a></button></th>
					<th><a href="participants_list.php">LIST OF PARTICITPANTS</a></th>
				</tr>
				<tr class="space">
					<td colspan=2></td>
				</tr>
